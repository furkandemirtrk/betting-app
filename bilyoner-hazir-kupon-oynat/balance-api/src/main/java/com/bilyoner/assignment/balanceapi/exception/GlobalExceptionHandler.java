...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler{
    ...
    public final ResponseEntity<?> handleExceptions(Exception ex, WebRequest request){
      ...
      if (ex instanceof BalanceApiException){
        errorResponse.setCode(((BalanceApiException) ex).getErrorCode().getCode());
        errorResponse.setMessage(((BalanceApiException) ex).getErrorCode().getMessage());
        log.error("BalanceApiException Error", ex);
      } else {
